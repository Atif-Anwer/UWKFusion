...
namespace Microsoft.Kinect.Fusion
{
    ...
    public class CameraParameters : IEquatable<CameraParameters>
    {
		...
		private const float CameraDepthNominalFocalLengthInPixels = 0.0f;
		...
		//private const float DepthNormFocalLengthX = 717.3649f / 512.0f;
		private const float DepthNormFocalLengthX = 0.0f;
		...
		//private const float DepthNormFocalLengthY = 688.00761f / 424.0f;
		private const float DepthNormFocalLengthY = 0.0f ;

		/// <summary>
		/// The x value of the depth normalized principal point.
		/// </summary>
		//private const float DepthNormPrincipalPointX = 0.511245f;
		//private const float DepthNormPrincipalPointX = 281.306f / 512.0f;
		private const float DepthNormPrincipalPointX = 0.0f;

		/// <summary>
		/// The y value of the depth normalized principal point.
		/// </summary>
		//private const float DepthNormPrincipalPointY = 0.489791f;
		//private const float DepthNormPrincipalPointY = 300.1535f / 424.0f;
		private const float DepthNormPrincipalPointY = 0.0f;
